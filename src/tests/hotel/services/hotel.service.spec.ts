...
import {
  Hotel,
  HotelDocument,
} from "../../../modules/hotel/models/hotel.model";
import {
  IHotelParams,
  SearchHotelParams,
  UpdateHotelParams,
} from "../../../modules/hotel/dto";
...
describe("HotelService", () => {
  ...
  describe("create", () => {
    ...
    it("should throw an error if create fails", async () => {
      ...
      await expect(
        hotelService.create({ title: "New Hotel" } as IHotelParams),
  ...
  describe("findById", () => {
    ...
    it("should throw NotFoundException if hotel is not found", async () => {
      ...
      await expect(hotelService.findById(mockHotel._id)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(hotelService.findById("invalidId")).rejects.toThrow(
        "Database error",
      );
    });
  });
  ...
  describe("search", () => {
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(
        hotelService.search({ title: "Hotel", offset: 0, limit: 10 }),
      ).rejects.toThrow("Database error");
    });
  });
  ...
  describe("update", () => {
    ...
    it("should throw an error if update fails", async () => {
      ...
      await expect(
        hotelService.update(mockHotel._id, updateData),
