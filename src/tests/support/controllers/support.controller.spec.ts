...
describe("SupportController", () => {
  ...
  beforeEach(async () => {
    ...
    supportRequestClientService = module.get<SupportRequestClientService>(
  ...
  describe("createSupportRequest", () => {
    it("should create a support request", async () => {
      ...
      mockSupportRequestClientService.createSupportRequest.mockResolvedValue(
        mockRequest,
      );
      ...
      expect(
        mockSupportRequestClientService.createSupportRequest,
  ...
  describe("getSupportRequests", () => {
    it("should return support requests for user", async () => {
      ...
      expect(mockSupportRequestService.findAllByUser).toHaveBeenCalledWith(
        userId,
        query,
      );
    });
  ...
  describe("getClientSupportRequests", () => {
    it("should return client support requests", async () => {
      ...
      mockSupportRequestService.findAllForManager.mockResolvedValue(
        mockRequests,
      );

      const result = await controller.getClientSupportRequests(
        limit,
        offset,
        isActive,
        req,
      ...
      expect(result).toEqual(mockRequests);
      expect(mockSupportRequestService.findAllForManager).toHaveBeenCalledWith({
        userId,
        limit,
        offset,
        isActive,
