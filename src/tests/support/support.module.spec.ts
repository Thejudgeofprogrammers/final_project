...
describe("SupportModule", () => {
  ...
  it("should be defined", () => {
    const supportRequestService = module.get<SupportRequestService>(
      SupportRequestService,
    );
    const supportRequestEmployeeService =
      module.get<SupportRequestEmployeeService>(SupportRequestEmployeeService);
    const supportRequestClientService = module.get<SupportRequestClientService>(
