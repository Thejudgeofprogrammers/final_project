...
describe("UsersController", () => {
  ...
  describe("createUserAdmin", () => {
    ...
    it("should throw ConflictException if email is already taken", async () => {
      ...
      mockUsersService.createManager.mockRejectedValue(
    ...
    it("should throw an error if required fields are missing", async () => {
      const mockData: Partial<UserDTO> = {
        email: "admin@example.com",
      };

      await expect(
        usersController.createUserAdmin(mockData as UserDTO),
      ).rejects.toThrow();
    ...
    it("should throw an error if required fields are missing in createUserManager", async () => {
      ...
      await expect(
        usersController.createUserManager(mockData as UserDTO),
  ...
  describe("createUserManager", () => {
    ...
    it("should throw ConflictException if email is already taken", async () => {
      ...
      await expect(usersController.createUserManager(mockData)).rejects.toThrow(
        ConflictException,
      );
