...
describe("UsersService", () => {
  ...
  describe("createUser", () => {
    ...
    it("should throw ConflictException if email is already taken", async () => {
      ...
      await expect(usersService.createUser(mockData)).rejects.toThrow(
        ConflictException,
      );
      expect(mockUserModel.findOne).toHaveBeenCalledWith({
        email: mockData.email,
  ...
  describe("createManager", () => {
    ...
    it("should throw an error if an unexpected error occurs during manager creation", async () => {
      ...
      await expect(usersService.createManager(mockData)).rejects.toThrow(
        "Unexpected error",
      );
  ...
  describe("findByEmail", () => {
    it("should rethrow any unexpected error", async () => {
      ...
      await expect(
        usersService.findByEmail("error@example.com"),
  ...
  describe("findById", () => {
    ...
    it("should rethrow any unexpected error", async () => {
      ...
      await expect(usersService.findById("error-id")).rejects.toThrow(
        "Database error",
      );
  ...
  describe("findAll", () => {
    ...
    it("should return users matching the search params", async () => {
      ...
      expect(usersService["userModel"].find).toHaveBeenCalledWith({
        ...
        contactPhone: expect.any(RegExp),
      });
    });
    ...
    it("should throw an error if an exception occurs", async () => {
      ...
      jest
        .spyOn(usersService["userModel"], "find")
        .mockImplementationOnce(() => {
          throw new Error("Database error");
        });

      await expect(usersService.findAll(mockParams)).rejects.toThrow(
        "Database error",
      );
    });
    ...
    it("should return an array of users based on search params", async () => {
      ...
      const query: FilterQuery<SearchUserParams> = {};
