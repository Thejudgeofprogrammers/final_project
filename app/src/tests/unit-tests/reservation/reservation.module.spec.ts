...
import { Reservation, ReservationSchema } from '../../../modules/reservation/models/reservation.model';
import { HotelRoom, HotelRoomSchema } from '../../../modules/hotel/models/hotel-room.model';
...
describe('ReservationModule', () => {
    ...
    it('should be defined', () => {
        const reservationService = module.get<ReservationService>(ReservationService);
        const reservationManagerService = module.get<ReservationManagerService>(ReservationManagerService);
        const reservationController = module.get<ReservationController>(ReservationController);
        const reservationManagerController = module.get<ReservationManagerController>(ReservationManagerController);
